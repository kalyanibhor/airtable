...
class Pagination extends Component {
  constructor(props) {
    super(props);
    const { totalRecords, pageLimit, pageNeighbours, offsetId } = props;
...
this.totalPages=this.props.offsetId.length;
  ...
  render() {
    ...
    const {offsetId}=this.props;
    console.log(offsetId[0]);
    let offsetNo=offsetId[0];
